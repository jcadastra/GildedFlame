 ...
 * Wall.java
 *
 * This class is a ObstacleSprite referencing a wall of the fish tank. All
 ...
 *
 * Note that we have similar classes in the other scenes (platform and rocket).
...
/**
 * A class representing a tiled surface (the fisht ank wall)
 *
...
public class Wall extends ObstacleSprite {
    ...
    /**
     * Creates a wall from the given set of points and physics units
     *
     ...
     */
    public Wall(float[] points, float units, JsonValue settings) {
        super();
