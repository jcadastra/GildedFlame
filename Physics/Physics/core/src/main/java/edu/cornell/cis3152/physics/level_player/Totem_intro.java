 ...
 */
public class Totem_intro extends GameplayScene implements ContactListener {
     ...
     */
    public Totem_intro(AssetDirectory directory) {
    ...
    private void populateLevel() {
        ...
        pname = "wall";
        plats = constants.get("platforms");
        platform = new Surface(new float[]{25f, 0f, 31f, 0f, 31f, 4f, 25f, 4f}, units, walls);
        platform.getObstacle().setName("wall");
        platform.setTexture(texture);
        addSprite(platform);
        ...
        goalDoor.getObstacle().setPosition(29f,6f);
...
//        torch.createSensor();
    ...
    public void beginContact(Contact contact) {
        ...
        try {
            ...
            if ((bd1 == avatar && bd2.getName().equals("goal") && avatar.getHasTorch()) ||
                (bd1.getName().equals("goal") && bd2 == avatar  && avatar.getHasTorch() )) {
                setComplete(true);
            }
