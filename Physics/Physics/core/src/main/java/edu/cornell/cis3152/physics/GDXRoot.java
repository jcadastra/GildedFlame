...
//    private String[] levels = new String[]{"move_intro","jump_intro","throw_intro","climb_intro","advanced_movement","box_intro","totem_intro","moth_intro","moth_medium","moth_medium_2", "rune_intro", "rune_medium", "rain_intro", "rain_medium", "rune_hard", "new_1", "new_2"};
    private String[] levels = new String[]{"rain_medium", "level1","level2","level3","interMove","level5","level4","level7","rune_medium","rune_advanced","rain_intro","new_2", "rune_hard", "rune_medium", "rain_intro", ""};
    private String[] levelNames = new String[]{"rain_medium", "level1","level2","level3","interMove","level5","level4","level7","rune_medium","rune_advanced","rain_intro","new_2", "rune_hard", "rune_medium", "rain_intro", ""};
