...
//    private String[] levels = new String[]{"move_intro","jump_intro","throw_intro","climb_intro","advanced_movement","box_intro","totem_intro","moth_intro","moth_medium","moth_medium_2", "rune_intro", "rune_medium", "rain_intro", "rain_medium", "rune_hard", "new_1", "new_2"};
    private String[] levels = new String[]{"first steps","don't look down","catch!","parkour!","i wonder where this goes","let me out!","freeze!", "beware", "up up and away","on my way!", "delivery!" ,"ur not passing this one","look up!", "chase!","psshhh"};
        private String[] levelNames = new String[]{"first steps","don't look down","catch!","parkour!","i wonder where this goes","let me out!","freeze!", "beware",  "up up and away", "on my way!", "delivery!" ,"ur not passing this one","look up!",  "chase!","psshhh"};
...
//            directory.unloadAssets();
    ...
    public void setGamePlaySceneLevel(int level) {
        ...
        if (prevScreen.equals("FailureScene") || prevScreen.equals("SuccssScene")) {
            ...
            setScreenWithTransition(() -> currentScene, levelNames[current], true, false);
        }
    ...
    public void setScreenWithTransition(
        ...
        if (current != null && !(current instanceof TransitionScreen)) {
            setScreen(new TransitionScreen(
                ...
                transitionText, fadeIn, fadeOut, directory
            ));
        } else {
