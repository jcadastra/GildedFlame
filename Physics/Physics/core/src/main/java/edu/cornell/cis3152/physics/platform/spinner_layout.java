 ...
 */
public class spinner_layout extends PhysicsScene implements ContactListener {
    ...
    private void populateLevel() {
        ...
        Surface platform;
        String pname = "platform0";
        JsonValue plats = constants.get("platforms");
        platform = new Surface(new float[]{1.0f, 0f, 60.0f, 0f, 60.0f, 1f,
            25f, 1f,25f,0.5f, 17f,0.5f,17f,1f,
            1.0f, 1f}, units, walls);
        ...
        JsonValue planks = constants.get("spinner_platform");
        ...
        texture = directory.getEntry( "platform-barrier", Texture.class );
        Spinner spinPlatform = new Spinner(units,constants.get("spinner_spinner"));
...
//        torch.createSensor();
        ...
        moth = new Moth(0, units, constants.get("spinner_moth"));
